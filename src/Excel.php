...
class Excel
{
    ...
    public function setSdkPath($sdkPath)
    {
        if($sdkPath) {
            ...
            if(!is_file($sdkPath)) {
                ...
                throw new Exception('PHPExcel sdk file does not exist:'.$sdkPath);
            }
        ...
        if(!class_exists('PHPExcel')) {
            ...
            throw new Exception('PHPExcel class does not exist');
        }
    ...
    public function export($data, $fields = [], $titleName = '', $fileName = '', $author = 'MrYe')
    {
        ...
        if($dimension < 2 || $dimension > 3) {
            ...
            throw new Exception('There is no exportable data');
        }
        ...
        try {
            ...
            //继续抛出异常
            throw new Exception($sheeti.'st export error:'.$exception->getMessage());
        }
    ...
    public function read($path, $sheeti = 0, $isDocking = false)
    {
        ...
        try {
            ...
            //继续抛出异常
            throw new Exception($i.'st red error:'.$exception->getMessage());
        }
